...
export const Flagship = [
  {
    ...
    link: "https://docs.google.com/forms/d/e/1FAIpQLSfr1zB84cR6IankdLdwvq_qzqSxEz1hy2I30HaXTn8gRS1csQ/viewform",
    description:
  ...
  },
  {
    ...
    link: "https://docs.google.com/forms/d/e/1FAIpQLSeK8XDLBOeOBRtEvqvfidrkiaBOSyxWGb6hAtfqZOYGTnxEtQ/viewform",
    description:
  ...
  },
  {
    ...
    link: "https://docs.google.com/forms/d/e/1FAIpQLSeQXztefM-lnc0PXqo2HDnFB2TICZsUQroeptdyWPDS32_pVw/viewform?usp=send_form",
    description:
...
export const NonContigent = [
  {
    ...
    link: "https://docs.google.com/forms/d/e/1FAIpQLSeJmISzynN6qlnU0wEFiSQWYISjNB9OkjwnTYuJiIbVIef6Yw/viewform?usp=send_form",
    description:
  ...
  },
  {
    ...
    link: "https://docs.google.com/forms/d/e/1FAIpQLSew0IqcOa8Zx7FqvHNhX9LT6q9yx5iDuKAiJ0l9UmIiAlInXA/viewform",
...

  {
    ...
    link: "https://docs.google.com/forms/u/0/d/1QW-DcnAokb9kbQ9wibnPb6JOusbXdwiiD27pwz9E50Y/viewform?edit_requested=true",
...
export const Robotics = [
  {
    title: "ROBO RACE",
    Image: require("./../media/race.jpg"),
    desc: "Design a robot either wired or wireless within the specified dimensions that can be operated manually and can travel through all turns of the track.",
    link: "https://forms.gle/UzRKttwcSLpFmYDx5",
    description:
      "Design a robot either wired or wireless within the specified dimensions that can  be operated manually and can travel through all turns of the track. The robot that will complete the specified task in least time will be the winner. Obstacle your robot can overcome big or small in the least of time.!",
  },
  {
    title: "ROBO CLENCH",
    Image: require("./../media/clench.jpg"),
    desc: "eams have to build a manually controlled bot which can do simple tasks of gripping Objects and putting them in target zones",
    link: "https://forms.gle/UzRKttwcSLpFmYDx5",
    description:
      "Teams have to build a manually controlled bot which can do simple tasks of gripping Objects and putting them in target zones so that it can complete the route by overcoming the Hurdles in its path.2) The robot can be wired or wireless. In case the bot is wired, there should be at least 2 meters of wire, so that it always remains slack. If the participants use wireless mechanisms they have to use either dual frequency remote, bluetooth or Wifi",
  },
  {
    title: "ROBO SUMO",
    Image: require("./../media/sumo.jpg"),
    desc: "The competition will involve two limited sized autonomous contesting Robo sumo which will compete within arena. ",
    link: "https://forms.gle/UzRKttwcSLpFmYDx5",
    description:
      "The competition will involve two limited sized autonomous contesting Robo sumo which will compete within arena. The purpose of the competition will be for one robot to eliminate the other by means of pushing it out of the arena or incapacitating it by tipping, disabling or overturning it within the bout time limit. The winner of the bout will be either the robot left functioning in the arena or the last robot out of the arena in the event that the winning robot falls out of the arena after it has pushed its opponent out.",
  },
  {
    title: "MESMERIZE",
    Image: require("./../media/meshmerizs.jpg"),
    desc: "eams have to build an autonomous robot which can follow a white line and keep track of directions while going through the maze",
    link: "https://forms.gle/UzRKttwcSLpFmYDx5",
    description:
      "Teams have to build an autonomous robot which can follow a white line and keep track of directions while going through the maze. The bot has to analyse the path in the dry run and has to go through the maze from the starting point to the ending point in minimum possible time",
  },
];
