...
export default function Navbar() {
    ...
    return (
        <nav className="navbar navbar-expand-lg my-1 main-background-effect " style={{ "borderRadius": "10px", "maxHeight": "50px" }} >
            <div className="container-fluid navbar-container">
                ...
                <div className="collapse navbar-collapse justify-content-end me-5" id="navbarSupportedContent" >
                    <ul className="col navbar-nav me-auto my-2 mb-lg-0 justify-content-end" style={{ "columnGap": "2.5vw", "letterSpacing": "0.1vw" }}>
                        <li className="nav-item">
                            <Link className="nav-link active text-light fw-light" aria-current="page" to='/'>Home</Link>
                        </li>
                        <li className="nav-item dropdown">
                            <Link className="nav-link dropdown-toggle text-light fw-light" to='/' role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                Events
                            </Link>
                            <ul className="dropdown-menu">
                                <li><Link className="dropdown-item" to='/flagship'>Flagship</Link></li>
                                <li><Link className="dropdown-item" to='/contingent'>Contingent</Link></li>
                                <li><Link className="dropdown-item" to='/noncontingent'>Non-Contingent</Link></li>
                            </ul>
                        </li>
