            ...
            <div className="container-fluid">
                <div className="row">
                    <div className="col-sm-6">
                        ...
                        <p className='text-light pt-5' style={{ "fontSize": "22px", "textAlign": "justify", "minWidth": "52vw", "maxWidth": "100%" }}>ICARUS is the enthusiastic Technical Festival of the Rajiv Gandhi Institute of Technology. With a footfall of over 2000 students, ICARUS celebrates the innovativeness of its engineering students.</p>
                        <button className='text-light my-2' style={{ "minWidth": "220px", "minHeight": "50px", "fontSize": "22px", "backgroundColor": "rgba(20,20,20,0.5)", "border": "none" }}><Link className='text-light' to="/" style={{ "textDecoration": "none" }}>Explore &rarr;</Link></button>
                    </div>
                    <div className="col-sm-6 text-light" style={{ "zIndex": "-1" }}>
                        <img src={photo01} style={{ "minWidth": "48vw", "maxWidth": "100%", "maxHeight": "100%", "WebkitTransform": "scaleX(-1)", "transform": "scaleX(-1)" }} alt="photo01" />
                        <div className="container pt-2" style={{ "backgroundColor": "rgba(20,20,20,0.5)", "backdropFilter": "blur(10px)", "letterSpacing": "0.25vh" }}>
                            <div className="row">
                                ...
                                <div className="col-sm-1">
                                    <div style={{ "marginLeft": "15px", "borderLeft": "1px solid rgba(255,255,255,0.5)", "minHeight": "10vh" }}></div>
                                </div>
