        ...
        <>
            <div style={{ "display": "flex", "paddingTop": "15px", "marginLeft": "80px" }}>
                <div className='py-4' style={{ "position": "relative", "left": "70px" }}>
                    ...
                    <p className='text-light' style={{ "fontSize": "22px", "text-align": "justify" }}>ICARUS is the enthusiastic Technical Festival of the Rajiv Gandhi Institute of Technology. With a footfall of over 2000 students, ICARUS celebrates the innovativeness of its engineering students.</p>
                ...
                <div style={{ "zIndex": "-1", "position": "relative" }}>
                    <img src={photo01} style={{ "width": "672px", "WebkitTransform": "scaleX(-1)", "transform": "scaleX(-1)" }} />
                    <div class="text-light px-5 py-3" style={{ "display": "flex", "flex": "right", "backgroundColor": "rgba(20,20,20,0.5)", "backdropFilter": "blur(10px)", "position": "absolute", "bottom": "0" }}>
